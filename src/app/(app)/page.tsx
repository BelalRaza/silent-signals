    ...
    <>
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 md:px-24 py-16 md:py-24 bg-background">
        ...
        <section className="text-center mb-12 md:mb-16 max-w-3xl">
          <div className="inline-flex items-center justify-center mb-6 px-4 py-2 bg-primary/10 rounded-full border border-primary/20">
            <MessageCircle className="w-4 h-4 mr-2 text-primary" />
            <span className="text-sm font-medium text-primary">Anonymous Feedback Platform</span>
          </div>
                ...
                <CarouselItem key={index} className="p-2">
                  <Card className="border-border/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <CardHeader className="pb-3">
                      <CardTitle className="text-lg text-foreground">{message.title}</CardTitle>
                    </CardHeader>
                    <CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-3xl mb-12">
          <div className="text-center p-6 rounded-lg bg-card border border-border/50">
            ...
            <h3 className="font-semibold text-foreground mb-2">Anonymous</h3>
            <p className="text-sm text-muted-foreground">Your identity stays completely private</p>
          </div>
          ...
          <div className="text-center p-6 rounded-lg bg-card border border-border/50">
            ...
            <h3 className="font-semibold text-foreground mb-2">Direct</h3>
            <p className="text-sm text-muted-foreground">Honest feedback delivered straight to you</p>
          </div>
          ...
          <div className="text-center p-6 rounded-lg bg-card border border-border/50">
            ...
            <p className="text-sm text-muted-foreground">A respectful community dedicated to growth</p>
          </div>
        </div>
      </main>
      ...
      <footer className="border-t border-border/50 py-8 px-4 bg-card/50">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Where your identity remains a secret</p>
          </div>
